...
func OpenAIOAuthConfig() OAuthProviderConfig {
	return OAuthProviderConfig{
		...
		ClientID:   os.Getenv("ODOOCLAW_OPENAI_CLIENT_ID"),
...
// Client credentials come from environment variables (ODOOCLAW_GOOGLE_CLIENT_ID / ODOOCLAW_GOOGLE_CLIENT_SECRET).
// These are the same client credentials used by the OpenCode/pi-ai plugin for Cloud Code Assist access.
func GoogleAntigravityOAuthConfig() OAuthProviderConfig {
	return OAuthProviderConfig{
		Issuer:       "https://accounts.google.com/o/oauth2/v2",
		TokenURL:     "https://oauth2.googleapis.com/token",
		ClientID:     os.Getenv("ODOOCLAW_GOOGLE_CLIENT_ID"),
		ClientSecret: os.Getenv("ODOOCLAW_GOOGLE_CLIENT_SECRET"),
