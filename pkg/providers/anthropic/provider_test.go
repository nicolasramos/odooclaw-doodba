...
func TestProvider_ChatRoundTrip(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		writeAnthropicTextStream(w, reqBody["model"], "Hello! How can I help you?", 15, 8)
	}))
	defer server.Close()
...
func writeAnthropicTextStream(w http.ResponseWriter, model any, text string, inputTokens int, outputTokens int) {
