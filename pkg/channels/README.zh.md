...
import (
    "github.com/nicolasramos/odooclaw/pkg/bus"
    "github.com/nicolasramos/odooclaw/pkg/channels"     // 引用父包
    "github.com/nicolasramos/odooclaw/pkg/config"
    "github.com/nicolasramos/odooclaw/pkg/identity"      // 新增
    "github.com/nicolasramos/odooclaw/pkg/media"          // 新增（如需媒体）
)
```
...
import (
    _ "github.com/nicolasramos/odooclaw/pkg/channels/telegram"   // 触发 init() 注册
    _ "github.com/nicolasramos/odooclaw/pkg/channels/discord"
    _ "github.com/nicolasramos/odooclaw/pkg/channels/your_new_channel"  // 新增
)
```
