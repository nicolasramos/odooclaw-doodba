...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.odooclaw")
	assert.Equal(t, "/home/user/.odooclaw/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.odooclaw/workspace/file.txt", "/home/user/.odooclaw")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".odooclaw"), result)
}
